...
const ResumenProducto = ({ producto }) => {
    ...
    const { modal, producto: productoActualizar, handleEditarCantidades, handleEliminarProducto } = useQuiosco();
        ...
        <>
            <div className='shadow p-5 mb-3 flex gap-10 items-center'>
                ...
                <div className='md:w-4/6'>
                    ...
                    <p className='mt-2'>Subtotal: {formatearDinero(producto.precio * producto.cantidad)}</p>
                </div>
                <div>
                    <button type="button"
            ...
            {modal && (
                <Modal
                    isOpen={modal}
                    style={customStyles}>
                    <ModalProducto producto={productoActualizar}/>
                </Modal>
            )}
            <ToastContainer />
        </>
